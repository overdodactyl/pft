...
test_that("validate_pft flags invalid sex", {
...
test_that("validate_pft flags pre/post swap", {
  d <- data.frame(sex = "M", age = 30, height = 170,
...
test_that("validate_pft passes a clean row", {
...
test_that("validate_pft handles NA gracefully (no false positives)", {
