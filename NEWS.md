...
package against the original source publications. Each audit lands a
...
**No corrections required.** The audit added explicit
paper-to-code traceability and 12 anchor-test assertions covering
6 representative (sex × age × height × measure) combinations;
