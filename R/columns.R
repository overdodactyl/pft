...
# ---- output schema -------------------------------------------------------
# pft_required_columns() (above) describes the inputs each pipeline stage
# expects. pft_schema() (below) is the symmetric counterpart: it
# enumerates every output column the pipeline can produce for a given
# configuration. Kept together so the input/output contract lives in one
# place.
